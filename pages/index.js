...
export default function Home() {
    ...
    // 1 से 31 मार्च का 100% सटीक डेटा (SG, FB, GZ, GL, DS + LUCKY 7 NIGHT)
    ...
    return (
        <div style={{ backgroundColor: '#fff', minHeight: '100vh', fontFamily: '"Arial Narrow", sans-serif', textAlign: 'center', margin: 0, padding: 0, overflowX: 'hidden' }}>
            ...
            {/* --- 3. COMPACT RESULT BOXES (SMALL SIZE - SCRNSHOT 33) --- */}
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', margin: '0 5px', borderLeft: '1.5px solid black', borderTop: '1.5px solid black', boxShadow: '0 4px 10px rgba(0,0,0,0.1)' }}>
                {gameList.map((game) => (
                    <div key={game.id} style={{ borderRight: '1.5px solid black', borderBottom: '1.5px solid black', padding: '12px 2px', backgroundColor: 'white' }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '4px' }}>
                            <span style={{ fontSize: '16px', fontWeight: 'bold' }}>&#123; {getLive(game.id, 'old')} &#125;</span>
                            <span style={{ color: '#5dade2', fontSize: '18px' }}>➡️</span>
                            <div style={{ border: '3px solid #000080', padding: '0 6px', backgroundColor: '#fff' }}>
                                <span style={{ fontSize: '30px', fontWeight: '900', color: '#000080' }}>[ {getLive(game.id, 'new')} ]</span>
                            </div>
                        </div>
                    </div>
                ))}
            ...
            {/* --- 4. ANIMATED PROMOTION (BELOW RESULTS) --- */}
            ...
            <div style={{ textAlign: 'left', padding: '20px', fontSize: '14px', color: '#333', marginTop: '30px', borderTop: '2px solid #800000' }}>
                <div style={{ border: '2px solid blue', padding: '15px', marginBottom: '15px' }}>
                    <h4 style={{ color: 'maroon', fontSize: '18px', margin: '0 0 10px 0' }}>What Is Satta King ?</h4>
